                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <form method="post">
                                        ...
                                        <div class="form-group  col-sm-4 mb-4">
                                            <input required type="number" step="any" min="0" name="estimated_arrival_time" class="form-control" id="estimated_arrival_time" placeholder="{{ __('messages.estimated_arrival_time') }}" value="{{ $store->deliveryByarea($data['area_id']) ? $store->deliveryByarea($data['area_id'])->estimated_arrival_time : '' }}" >
                                        </div>
                                        <div class="form-group  col-sm-4 mb-4">
