                ...
                <table id="without-print" class="table table-hover non-hover" style="width:100%">
                    ...
                    <tbody>
                        ...
                        @foreach ($data['ads'] as $ad)
                            <tr>
                                <td><?=$i;?></td>
                                <td><img src="https://res.cloudinary.com/dezsm0sg7/image/upload/w_100,q_100/v1581928924/{{ $ad->image }}"  /></td>
                                <td>{{ $ad->place == 1 ? __('messages.inside_slider') : __('messages.normal_ad') }}</td>
