                                ...
                                <li class="nav-item">
                                    <div class="nav-link list-actions" id="invoice-{{ $data['order']['main_order_number'] }}" data-invoice-id="{{ $data['order']['main_order_number'] }}">
                                        <div class="f-m-body">
                                            ...
                                            <div class="f-body">
                                                <p class="invoice-number">{{ __('messages.invoice') }} #{{ $data['order']['main_order_number'] }}</p>
                ...
                <div class="invoice-container">
                    <div class="invoice-inbox ps ps--active-y" style="height: calc(100vh - 197px);">
                        ...
                        <div class="invoice-header-section" style="display: flex;">
                            <h4 class="inv-number">{{ $data['order']['main_order_number'] }}#</h4>
                        ...
                        <div id="ct" class="" style="display: block;">
                            ...
                            <div class="invoice-{{ $data['order']['main_order_number'] }}">
                                <div class="content-section  animated animatedFadeInUp fadeInUp">
                                    ...
                                    <div class="row inv--head-section">
                                        ...
                                        <div class="col-sm-6 col-12 align-self-center text-sm-right">
                                            <div class="company-info">
                                                <img src="https://res.cloudinary.com/dezsm0sg7/image/upload/w_100,q_100/v1581928924/<?=Auth::user()->custom['setting']['logo']?>" class="navbar-logo" alt="logo">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row inv--detail-section">
                                        ...
                                        <div class="col-sm-5 align-self-center  text-sm-right order-2">
                                            <p class="inv-list-number"><span class="inv-title">{{ __('messages.order_number') }}: </span> <span class="inv-number">#{{ $data['order']['main_order_number'] }}</span></p>
                                                ...
                                                <table class="table">
                                                    <thead class="">
                                                        <tr>
                                                            ...
                                                            <th class="text-right" scope="col">{{ __('messages.status') }}</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-right">{{ (double)$item->product->final_price * (double)$item->count }} {{ __('messages.dinar') }}</td>
                                                            <td class="text-right">
                                                                @if ($item->status == 1)
                                                    ...
                                                    <tfoot>
                                                    <tr>
                                                        <td class="text-right">{{ __('messages.total') }}<td>
                                                        <td></td>
                                                        <td class="text-right">{{ __('messages.delivery_cost') }}</td>
                                                        <td></td>
                                                        <td class="text-right"></td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="text-right">{{ $order->subtotal_price }} {{ __('messages.dinar') }}<td>
                                                        <td></td>
                                                        <td class="text-right">{{ $order->delivery_cost }} {{ __('messages.dinar') }}</td>
                                                        <td></td>
                                                        <td></td>
                                                        <td></td>
                                                    </tr>
