        ...
        <form action="" method="post" enctype="multipart/form-data" >
            ...
            <div class="form-group" >
                ...
                <select id="typeSelect" name="type" class="form-control">
                    ...
                    <option {{ $data['section']['type'] == 1 ? 'selected' : '' }} value="1">{{ __('messages.slider') }}</option>
                    <option {{ $data['section']['type'] == 2 ? 'selected' : '' }} value="2">{{ __('messages.normal') }}</option>
                </select>
            </div>
            <div style="{{ $data['section']['type'] == 2 ? 'display: none' : '' }}" id="ads_check" class="row" >
                ...
                <div class="col-md-3" >
                    <div >
                        <label class="new-control new-checkbox new-checkbox-text checkbox-primary">
                            <input {{ in_array($ad->id, $data['ids']) ? 'checked' : '' }} name="products[]" value="{{ $ad->id }}" type="checkbox" class="new-control-input">
                            <span class="new-control-indicator"></span><span class="new-chk-content"><img src="https://res.cloudinary.com/dezsm0sg7/image/upload/w_100,q_100/v1581928924/{{ $ad->image }}" /></span>
                        </label>
                    </div>     
                </div>
