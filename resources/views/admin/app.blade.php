        ...
        <header class="header navbar navbar-expand-sm">
            ...
            <ul class="navbar-item theme-brand flex-row  text-center">
                <li class="nav-item theme-logo">
                    <a href="/admin-panel">
                        <img src="https://res.cloudinary.com/dezsm0sg7/image/upload/w_50/v1581928924/<?=Auth::user()->custom['setting']['logo']?>" class="navbar-logo" alt="logo">
                    </a>
                </li>
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                   ...
                   @if(in_array(1 , Auth::user()->custom['admin_permission'])) 
                    ...
                    <li class="menu sliders">
                        <a href="{{ route('sliders.edit', 3) }}" class="dropdown-toggle first-link">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-airplay"><path d="M5 17H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2h-1"></path><polygon points="12 15 17 21 7 21 12 15"></polygon></svg>
                                <span>{{ __('messages.home_page_slider') }}</span>
                            </div>
                        </a>
                    </li>
                    @endif 
                    ...
                    @if(in_array(28 , Auth::user()->custom['admin_permission']))
                    ...
                    <li class="menu shops">
                        ...
                        <ul class="collapse submenu list-unstyled show" id="shops" data-parent="#accordionExample">
                            @if(Auth::user()->add_data) 
                                <li class="active add">
                                    <a href="{{ route('shops.add') }}"> {{ __('messages.add') }} </a>
                                </li>
                            @endif
                            <li class="show" >
                    ...
                    <li class="menu refund">
                        <a href="{{ route('refund.index') }}" class="dropdown-toggle first-link">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-inbox"><polyline points="22 12 16 12 14 15 10 15 8 12 2 12"></polyline><path d="M5.45 5.11L2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z"></path></svg>
                                <span>{{ __('messages.refund_requests') }}
                                      @if( Auth::user()->custom['refund_count'] > 0 )   
                                      <span class="unreadcount" > 
                                            <span class="insidecount" > 
                                                <?=Auth::user()->custom['refund_count']?> 
                                            </span> 
                                      </span>
                                      @endif  
                                 </span>
                    ...
                    <li class="menu wallet">
                        <a href="{{ route('wallet.index') }}" class="dropdown-toggle first-link">
                            <div class="">
                    ...
                    <li class="menu store_notifications">
                        <a href="#store_notifications" data-active="true" data-toggle="collapse" aria-expanded="true" class="dropdown-toggle first-link">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-bell"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path><path d="M13.73 21a2 2 0 0 1-3.46 0"></path></svg>
                                <span>{{ __('messages.sellers_notifications') }}</span>
                            </div>
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg>
                            </div>
                        </a>
                        <ul class="collapse submenu list-unstyled show" id="store_notifications" data-parent="#accordionExample">
                            @if(Auth::user()->add_data) 
                                <li class="active send">
                                    <a href="/admin-panel/store_notifications/send"> {{ __('messages.send') }} </a>
                                </li>
                            @endif
                            <li class="show" >
                                <a href="/admin-panel/store_notifications/show"> {{ __('messages.show') }} </a>
                            </li>
                        </ul>
                    </li>
                    @endif 
