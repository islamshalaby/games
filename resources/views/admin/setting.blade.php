    ...
    <form method="post" action="" enctype="multipart/form-data" >
        @csrf
         <div class="form-group mb-4">
            ...
            <br>
            <img src="https://res.cloudinary.com/dezsm0sg7/image/upload/w_100,q_100/v1581928924/{{$data['setting']['logo']}}" >    
        </div>
        ...
        <div class="form-group mb-4">
            ...
            <input  type="text" name="delivery_cost" class="form-control" id="delivery_cost" placeholder="{{ __('messages.delivery_cost') }}" value="{{$data['setting']['delivery_cost']}}" >
        </div>     
