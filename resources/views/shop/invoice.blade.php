                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-12">
                            ...
                            <ul class="nav nav-pills inv-list-container d-block" id="pills-tab" role="tablist">
                                <li class="nav-item">
                                    <div class="nav-link list-actions" id="invoice-{{ $data['order']['main_order_number'] }}" data-invoice-id="{{ $data['order']['main_order_number'] }}">
                                        <div class="f-m-body">
                                            <div class="f-head">
                                            ...
                                            <div class="f-body">
                                                ...
                                                <p class="invoice-generated-date">{{ __('messages.date') }}: {{ $data['order']->main->created_at->format("d-m-y") }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <div class="content-section  animated animatedFadeInUp fadeInUp">
                                    ...
                                    <div class="row inv--head-section">
                                        ...
                                        <div class="col-sm-6 col-12 align-self-center text-sm-right">
                                            <div class="company-info">
                                                <img src="https://res.cloudinary.com/dezsm0sg7/image/upload/w_50,q_50/v1581928924/{{ Auth::user()->logo }}" class="navbar-logo" alt="logo">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row inv--detail-section">
                                        ...
                                        <div class="col-sm-5 align-self-center  text-sm-right order-2">
                                            <p class="inv-list-number"><span class="inv-title">{{ __('messages.main_order_number') }} : </span> <span class="inv-number"># {{ $data['order']->main->main_order_number }}</span></p>
                                            <p class="inv-created-date"><span class="inv-title">{{ __('messages.date') }} : </span> <span class="inv-date">{{ $data['order']->main->created_at->format("d-m-y") }}</span></p>
                                            <p class="inv-due-date"><span class="inv-title">{{ __('messages.deliver_date') }} : </span> <span class="inv-date"> {{ __('messages.from') . " " . $data['order']->from_deliver_date->format('d-m-Y') . " " . __('messages.to') . " " . $data['order']->to_deliver_date->format('d-m-Y') }}</span></p>
                                        </div>
                                    </div>

                                    <h5>{{ $data['order']->store->name }}</h5>
                                    <p><b>{{ __('messages.sub_order_number') }} : </b> {{ $data['order']['order_number'] }}</p>
                                                ...
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-right">{{ $item->price_before_offer }} {{ __('messages.dinar') }}</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td></td>
                                                        <td class="text-right">{{ $data['order']->subtotal_price }} {{ __('messages.dinar') }}</td>
                                                    </tr>
                                                    <tfoot>
                                                </table>
                                            </div>
