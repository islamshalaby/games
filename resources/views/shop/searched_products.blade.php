            ...
            <div style="margin-bottom: 50px" class="widget-header">
                ...
                <div class="col-md-12">
                    <div class="mx-auto center-block add-prod-container text-center">
                        ...
                        @if (isset($data['cat']))
                        <a href="{{ route('products.store.add') . '?cat=' . $data['cat'] }}" class="btn btn-warning">{{ __('messages.add_new_product') }}</a>
                        @else
                        <a href="{{ route('products.store.add') }}" class="btn btn-warning">{{ __('messages.add_new_product') }}</a>
                        @endif
                    </div>
                </div>
            </div>
