    ...
    <script>
                ...
                $.ajax({
                    ...
                    success : function (data) {
                        ...
                        data.forEach(function (option) {
                            ...
                            `
                            var propValSelect = `
                            <select id="multi${option.id}" class="form-control multi_tags" multiple name="multi_option_value_id[]">
                                ${propValOption}
                            </select>
                            `
                            ...
                            <div class="col-sm-2 text-option">
                                <div class="n-chk">
                                    <label class="new-control new-checkbox new-checkbox-text checkbox-primary">
                                      <input checked data-multi="multi${option.id}" name="multi_option_id" type="radio" value="${option.id}" class="new-control-input all-permisssions">
        ...
        $("#properties-items .row").on('click', 'select', function() {
            ...
            $(".actions ul").find('li').eq(1).on("mouseover", "a.next1", function() {
                ...
                if (image.length > 0 && categorySelect > 0 && titleEnInput.length > 0 && titleArInput.length > 0 && descriptionEnText.length > 0 && descriptionArText.length > 0 && typeSelect > 0 && periodInput.length > 0) {
                    $(this).attr('href', '#next')
                    $(this).addClass('next2')
                }else {
                    $(this).attr('href', '#')
            ...
            $(".actions ul").find('li').eq(1).on('click', function() {
                ...
                if ($(".steps ul").find('li').eq(2).hasClass('current')) {
                    {{-- $("#multi_options_radio .row").on('change', 'input[type="radio"]', function() { --}}
                        ...
                        if ($("#multi_options_radio .row").find('input[type="radio"]').val() == 8) {
                            console.log($("#multi_options_radio .row").find('input[type="radio"]').val())
                        ...
                        var multiId = $("#multi_options_radio .row").find('input[type="radio"]').data('multi')
                        if ($("#multi_options_radio .row").find('input[type="radio"]').is(":checked")) {
                            console.log("test")
                            $("select.multi_tags").prop('disabled', true)
                            $(`#${multiId}`).prop('disabled', false)
                            $(`#${multiId}`).prop('required', true)
                    ...
                    <div id="circle-basic" class="">
                        ...
                        <section>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" name="video" class="form-control" id="video" placeholder="{{ __('messages.video_link') }}" value="{{ old('video') }}" >
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select required id="typeSelect" name="type" class="form-control">
                                    ...
                                    <option value="1">{{ __('messages.ready_clothes') }}</option>    
                                    <option value="2">{{ __('messages.tailoring_clothes') }}</option>  
                                </select>
                            </div>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input required type="number" name="order_period" class="form-control" id="order_period" placeholder="{{ __('messages.order_period') }}" value="{{ old('order_period') }}" >
                            </div>
                        </section>
