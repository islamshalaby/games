...
class StoreNotificationController extends AdminController{
    ...
    public function send(Request $request){
        ...
        $notificationss = APIHelpers::send_notification_store($notification->title , $notification->body , $the_image , null , $fcm_tokens); 
        // dd($notificationss);   
        return redirect('admin-panel/store_notifications/show');
    }
    ...
    public function resend(Request $request){
        ...
        APIHelpers::send_notification_store($notification->title , $notification->body , $notification->image , null , $array_values);
